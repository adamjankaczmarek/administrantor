  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved presence as @presence" do
        ...
        post :create, {:presence => { "altar_boy" => "invalid value" }}, valid_session
        assigns(:presence).should be_a_new(Presence)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested presence" do
        ...
        Presence.any_instance.should_receive(:update).with({ "altar_boy" => "" })
        put :update, {:id => presence.to_param, :presence => { "altar_boy" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the presence as @presence" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Presence.any_instance.stub(:save).and_return(false)
        put :update, {:id => presence.to_param, :presence => { "altar_boy" => "invalid value" }}, valid_session
        assigns(:presence).should eq(presence)
      end
