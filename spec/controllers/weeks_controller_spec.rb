  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved week as @week" do
        ...
        post :create, {:week => { "year" => "invalid value" }}, valid_session
        assigns(:week).should be_a_new(Week)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested week" do
        ...
        Week.any_instance.should_receive(:update).with({ "year" => "1" })
        put :update, {:id => week.to_param, :week => { "year" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the week as @week" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Week.any_instance.stub(:save).and_return(false)
        put :update, {:id => week.to_param, :week => { "year" => "invalid value" }}, valid_session
        assigns(:week).should eq(week)
      end
