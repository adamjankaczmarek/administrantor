  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created tariff" do
        post :create, {:tariff => valid_attributes}, valid_session
        response.should redirect_to(Tariff.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tariff as @tariff" do
        ...
        post :create, {:tariff => { "name" => "invalid value" }}, valid_session
        assigns(:tariff).should be_a_new(Tariff)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tariff" do
        ...
        Tariff.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => tariff.to_param, :tariff => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the tariff" do
        tariff = Tariff.create! valid_attributes
        put :update, {:id => tariff.to_param, :tariff => valid_attributes}, valid_session
        response.should redirect_to(tariff)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the tariff as @tariff" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tariff.any_instance.stub(:save).and_return(false)
        put :update, {:id => tariff.to_param, :tariff => { "name" => "invalid value" }}, valid_session
        assigns(:tariff).should eq(tariff)
      end
