...
describe "celebration_weekly_schemas/edit" do
  before(:each) do
  ...
  it "renders the edit celebration_weekly_schema form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", celebration_weekly_schema_path(@celebration_weekly_schema), "post" do
